...
export const OpenWindowSearchProvider = class {
    constructor() {
        this.id = 'community-menu.open-windows';
        ...
        this.appInfo = {
            ...
            get_id: () => 'community-menu.open-windows',
    ...
    _getFilteredWindowIds(terms, appWindows) {
        ...
        appWindows = appWindows.filter(aw => {
            ...
            return terms.every(term => title?.includes(term) || appName?.includes(term) ||
